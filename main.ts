...
namespace mbit_小车类 {
    ...
    export enum enMusic {
        ...
        //% blockId="dadadum" block="默认音乐"
		dadadum = 0,
		//% blockId="entertainer" block="大娱乐家"
        entertainer,
		//% blockId="prelude" block="序曲"
        prelude,
        ...
        funk,
		//% blockId="blues" block="蓝调"
        blues,
		//% blockId="birthday" block="生日"
        birthday,
		//% blockId="wedding" block="婚礼"
        wedding,
		//% blockId="funereal" block="悲伤"
        funereal,
		//% blockId="punchline" block="搞笑"
        punchline,
		//% blockId="baddy" block="坏人"
        baddy,
        ...
        jump_down,
		//% blockId="power_up" block="开启"
        power_up,
		//% blockId="power_down" block="关闭"
        power_down
    }
    export enum enPos {
